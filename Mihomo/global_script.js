...
const allRegionDefinitions = [
  {
    ...
    icon: 'https://raw.githubusercontent.com/Lanlan13-14/Icon-for-webui/main/Hongkong.png',
  },
  {
    name: 'US美国',
    regex: /(?!.*aus)(?=.*(美|🇺🇸|us(?!t)|usa|american|united states)).*/i,
    filter: '(?i)(?!.*aus)(?=.*(美|🇺🇸|us(?!t)|usa|american|united states)).*',
    icon: 'https://raw.githubusercontent.com/Lanlan13-14/Icon-for-webui/main/America.png',
  },
  {
    name: 'JP日本',
    regex: /日本|🇯🇵|jp|japan/i,
  ...
  },
  {
    ...
    regex: /韩|🇰🇷|kr|korea/i,
    filter: '(?i)韩|🇰🇷|kr|korea',
    icon: 'https://raw.githubusercontent.com/Lanlan13-14/Icon-for-webui/main/Korea.png',
  },
  {
    name: 'SG新加坡',
    regex: /新加坡|🇸🇬|sg|singapore/i,
    filter: '(?i)新加坡|🇸🇬|sg|singapore',
    icon: 'https://raw.githubusercontent.com/Lanlan13-14/Icon-for-webui/main/Singapore.png',
  },
  {
    name: 'TW台湾省',
    regex: /台湾|台灣|🇹🇼|tw|taiwan|tai wan/i,
    filter: '(?i)台湾|台灣|🇹🇼|tw|taiwan|tai wan',
    icon: 'https://raw.githubusercontent.com/Lanlan13-14/Icon-for-webui/main/Taiwan_China.png',
  },
  {
    name: 'GB英国',
    regex: /英|🇬🇧|uk|united kingdom|great britain/i,
    filter: '(?i)英|🇬🇧|uk|united kingdom|great britain',
    icon: 'https://raw.githubusercontent.com/Lanlan13-14/Icon-for-webui/main/European.png',
  },
  {
    name: 'DE德国',
...
const serviceConfigs = [
  ...
  },
  {
    key: 'youtube',
    name: 'YouTube',
    icon: 'https://raw.githubusercontent.com/Lanlan13-14/Icon-for-webui/main/youtube.png',
  ...
  },
  {
    key: 'bahamut',
    name: '巴哈姆特',
    icon: 'https://raw.githubusercontent.com/Lanlan13-14/Icon-for-webui/main/bahamut.png',
  ...
  },
  {
    key: 'disney',
    name: 'Disney+',
    icon: 'https://raw.githubusercontent.com/Lanlan13-14/Icon-for-webui/main/disney.png',
  ...
  },
  {
    key: 'netflix',
    name: 'NETFLIX',
    icon: 'https://raw.githubusercontent.com/Lanlan13-14/Icon-for-webui/main/netflix.png',
  ...
  },
  {
    key: 'tiktok',
    name: 'Tiktok',
    icon: 'https://raw.githubusercontent.com/Lanlan13-14/Icon-for-webui/main/tiktok.png',
  ...
  },
  {
    key: 'hbo',
    name: 'HBO',
    icon: 'https://raw.githubusercontent.com/Lanlan13-14/Icon-for-webui/main/hbo.png',
  ...
  },
  {
    key: 'primevideo',
    name: 'Prime Video',
    icon: 'https://raw.githubusercontent.com/Lanlan13-14/Icon-for-webui/main/primevideo.png',
  ...
  },
  {
    key: 'telegram',
    name: 'Telegram',
    icon: 'https://raw.githubusercontent.com/Lanlan13-14/Icon-for-webui/main/telegram.png',
  ...
  },
  {
    key: 'whatsapp',
    name: 'WhatsApp',
    icon: 'https://raw.githubusercontent.com/Lanlan13-14/Icon-for-webui/main/whatsapp.png',
  ...
  },
  {
    key: 'line',
    name: 'Line',
    icon: 'https://raw.githubusercontent.com/Lanlan13-14/Icon-for-webui/main/line.png',
  ...
  },
  {
    key: 'games',
    name: '游戏专用',
    icon: 'https://raw.githubusercontent.com/Lanlan13-14/Icon-for-webui/main/game.png',
    rules: [
...
function main(config) {
  ...
  if (otherProxies.length > 0 || hasProviders) {
    const otherGroup = {
      ...
      name: '其他节点',
      type: 'select',
      icon: 'https://raw.githubusercontent.com/Lanlan13-14/Icon-for-webui/main/global.png',
    }
  ...
  const defaultNodeGroup = {
    ...
    icon: 'https://raw.githubusercontent.com/Lanlan13-14/Icon-for-webui/main/all.png',
  }
  if (hasProviders) {
...
// 其他功能组：不展开节点
  ...
  functionalGroups.push(
    buildFixedGroup({
      ...
      icon: 'https://raw.githubusercontent.com/Lanlan13-14/Icon-for-webui/main/global_media.png',
    }),
    buildFixedGroup({
      name: '国内网站',
      type: 'select',
      ...
      icon: 'https://raw.githubusercontent.com/Lanlan13-14/Icon-for-webui/main/Chinese_media.png',
    })
  )
